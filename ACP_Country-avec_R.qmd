...
```{r}
# les similarités et différences entre individus et variables 
...
# Etape 5: Revenir aux données brutes pour interpréter

```{r}
# 1. Contribution des variables sur les axes principaux
contributions_variables <- resultat_acp$var$contrib
print("Contribution des variables sur les axes principaux :")
print(contributions_variables)

# 2. Contributions des individus (pays)
contributions_individus <- resultat_acp$ind$contrib
print("Contribution des individus (pays) sur les axes principaux :")
print(contributions_individus)

# 3. Corrélation entre les axes principaux et les variables initiales
corr_axes_variables <- resultat_acp$var$cor
print("Corrélation entre les axes principaux et les variables initiales :")
print(corr_axes_variables)

# 4. Identifier les pays les plus influents sur les axes principaux
individus_significatifs <- contributions_individus[order(-contributions_individus[, 1]), ]
print("Individus les plus influents sur le premier axe :")
print(head(individus_significatifs))
```
